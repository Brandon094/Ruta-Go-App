package com.chopcode.rutago.app.managers.auths;
...
public class AuthManager {
    ...
    public boolean validateLogin(Context context) {
        ...
        if (!isLoggedIn) {
            Log.w(TAG, "❌ User no autenticado - redirigiendo a login");
            Toast.makeText(context, "Debes iniciar sesión", Toast.LENGTH_SHORT).show();
            redirectToLogin(context);
            return false;
        }

        Log.d(TAG, "✅ User validado correctamente");
        return true;
    }
    ...
    public void logAuthStatus() {
        ...
        Log.d(TAG, "   - User autenticado: " + (user != null));

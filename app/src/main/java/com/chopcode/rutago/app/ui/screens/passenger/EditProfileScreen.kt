...
import com.chopcode.rutago.app.ui.viewmodels.passenger.EditProfileUiState

/**
 * 📱 SCREEN: EditProfileScreen
 * Pantalla para que el pasajero actualice sus datos de contacto.
 */
...
private fun CurrentInfoCard(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            InfoRow(icon = Icons.Default.Person, text = name)

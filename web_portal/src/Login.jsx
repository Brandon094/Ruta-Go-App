    ...
    <div className="space-y-1.5 group">
      ...
      <div className="relative">
        ...
        <input
          type={type}
          required
          className="block w-full pl-12 pr-4 py-4 bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 rounded-2xl text-slate-800 dark:text-white font-bold focus:outline-none focus:ring-4 focus:ring-primary-500/10 focus:border-primary-500 transition-all placeholder:opacity-30 text-sm"

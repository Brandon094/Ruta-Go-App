      ...
      <nav className="fixed top-0 w-full bg-white/90 dark:bg-[#061426]/90 backdrop-blur-md z-50 border-b border-slate-200 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-3 md:px-6 h-16 md:h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-3">
            <div className="w-8 h-8 md:w-10 md:h-10 bg-[#061426] dark:bg-[#FF7A1A] rounded-lg md:rounded-xl flex items-center justify-center shadow-lg shrink-0 transition-colors">
          ...
          <div className="flex items-center gap-1.5 md:gap-4">
            <button onClick={onLogin} className="px-2 md:px-6 py-2 font-bold text-slate-600 dark:text-white/60 hover:text-primary-500 transition-colors text-[10px] md:text-sm">
              Iniciar Sesión
            </button>
            <button onClick={onRegisterOwner} className="px-3 md:px-6 py-2 bg-[#061426] dark:bg-[#FF7A1A] text-white font-bold rounded-xl shadow-xl hover:bg-black dark:hover:bg-primary-600 transition-all active:scale-95 text-[9px] md:text-sm uppercase tracking-wider">
              Ser Dueño
               ...
               {solutions.map((_, i) => (
                 <button
                   ...
                   className={`h-2 rounded-full transition-all duration-300 ${
                     i === activeSolution ? 'w-8 bg-primary-500' : 'w-2 bg-slate-200 dark:bg-white/10'
                   }`}
                 />
               ))}
             </div>

# 📱 Arquitectura de la Aplicación Android - Ruta-Go v1.5.1

Este documento detalla la arquitectura de ingeniería de la App nativa de Ruta-Go (Sincronizada con Suite v1.9.9.8), diseñada bajo un paradigma **Reactivo, Transaccional y Multicapa (MVVM)**, optimizado para el ecosistema móvil y compatible con las últimas APIs de Google.

...
Este documento detalla la estructura, flujo de datos y gobernanza del **Ruta-Go Web Portal** (v1.8.6), la plataforma centralizada para la gestión del Holding Tecnológico que conecta Nátaga y La Plata.
...
*   **Estructura Atómica (Auditada v1.8.6)**:
